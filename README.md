...
Danny J. Pérez M. e-Mail: perezdann at gmail dot com
Version: 1.0.6.deb8 "Daenerys"
July 09, 2016
Caracas, Venezuela.

Based on 1.0.5 ubuntu16lts by Reynaldo R. Martinez P. e-Mail: TigerLinux at gmail dot com

OpenStack MITAKA for Debian 8

## Introduction

This installer was made to automate the tasks of creating a virtualization infrastructure based on OpenStack..

This produce a fully production-grade OpenStack installation. You can use this installer to make a single-node all-in-one OpenStack server, or a more complex design with controller and compute nodes. You can also use this installer (with small modifications made by yourself) in order to create a redundant infrastructure.
