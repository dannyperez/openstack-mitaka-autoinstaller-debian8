...
"install")
	...
	echo "Flavor: OpenStack MITAKA for Debian 8"
	echo "Made by: Danny J. Pérez M. (Based on Reynaldo R. Martinez P. for Ubuntu 16lts)"
	echo "E-Mail: perezdann@Gmail.com"
	echo "Version 1.0.6.deb8 \"Lynx Pardinus\" - Jujy 09, 2016"
	echo ""
	echo "I'll verify all requiremens"
	echo "If any requirement is not met, I'll stop and inform what's missing"
	echo ""
	echo "Requirements"
	echo "- OS: Debian 8 x86_64 fully updated"
