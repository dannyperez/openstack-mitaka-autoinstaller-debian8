...
"qpid")
	...
	# DEBIAN_FRONTEND=noninteractive apt-get -y install qpidd python-cqpid python-qpid python-qpid-extras-qmf qpid-client sasl2-bin
	apt-get -y install qpidd python-qpid qpid-client sasl2-bin libqpidmessaging2 qpidd-msgstore
